...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.victorlucas.cursomc.controllers"))
	...
	private ApiInfo apiInfo() {
		...
		new Contact("Victor Lucas", "https://www.linkedin.com/in/victor-lucas-52ba3b17a/", "victorlucas.ao@gmail.com"),
